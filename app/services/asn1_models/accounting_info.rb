  ...
  def as_json(options = {})
    {
      text: 'AccountingInfo',
      children: [
        { text: "LocalCurrency: #{@local_currency}" },
        { text: "TapCurrency: #{@tap_currency}" },
        {
          text: 'CurrencyConversionInfo',
          children: @currency_conversion_info
        },
        { text: "TapDecimalPlaces: #{@tap_decimal_places}" }
      ]
